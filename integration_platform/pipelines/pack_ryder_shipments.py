...
class PackRyderShipments(Pipeline):
    def __init__(self, function: str, env: str='prod'):
        super().__init__(pipeline_name='pack-ryder-shipments', function=function, env=env)
    ...
    def extract(self) -> pl.DataFrame:
        ...
        data_extract = self.acudb.query_to_dataframe(self.acudb.queries.ShipChairRemovalSeparate)
        dbc_extract = self.centralstore.query_db('select * from ryder.ShipmentItems')
        return data_extract
