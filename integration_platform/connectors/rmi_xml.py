...
if TYPE_CHECKING:
    from integration_platform.pipelines.rmi_send_shipments import SendRMIShipments
    from integration_platform.pipelines.rmi_send_returns import SendRMIReturns
import requests
