...
create view analytics.JHL_CurrentBackorders_CustomerClass_30d
as
with TopLevel as(
...
, SecondLevel as(
	select  *
		 , case when DaysOnBackorder <= -30 then 1 else 0 end OlderThanMonth
		 ...
		 'C0083562', 'C0083562', 'C0073987'
			...
			then 1 else 0 end Chargeback
	from TopLevel
	where PITdesc = 1 --and DaysOnBackorder <= -30
)
select OlderThanMonth
	 , CustomerClass
