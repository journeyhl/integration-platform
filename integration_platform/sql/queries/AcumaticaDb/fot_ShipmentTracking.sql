...
select sh.ShipmentNbr
     ...
     , case when c.CustomerClassID = 'B2B' or s.OrderType = 'RT' then 1 else 0 end B2B
...
where s.CompanyID = 2 
and dateadd(hour, -4, sh.CreatedDatetime) >=  dateadd(day, -30, getdate())
