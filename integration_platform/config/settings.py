...
TABLES = {
    ...
    'ucmiraw.HubspotCustomers': {
        ...
        'columns': [
            ...
            'EcommerceContact',
            'SourceStore',
            'DateBecameTheNewLeadStatus',
            'DateBecameTheOpenLeadLeadStatus',
            'DateBecameTheOutboundLeadStatus',
            'DateBecameTheReservedLeadStatus',
            'DateBecameTheSoldLeadStatus',
            'DateBecameTheUnqualifiedLeadStatus',
            'DateBecameTheDncLeadStatus',
            'DateBecameTheLeadExhaustedLeadStatus',
            'FirstConversion',
            'FirstConversionDate',
            'Sold',
